-- Uzupełnienie tabeli public.etapy (uruchom w Supabase SQL Editor), jeśli kolumn brakuje.
...
COMMENT ON COLUMN public.etapy.osoba_odpowiedzialna IS 'Nr z tabeli pracownik (jak w KR)';
COMMENT ON COLUMN public.etapy.osiagniete IS 'NULL = nie ustawiono';
COMMENT ON COLUMN public.etapy.zagrozenie IS 'NULL = nie ustawiono';
