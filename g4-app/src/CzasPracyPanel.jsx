...
import { KR_OGOLNOBIUROWY, normalizujKrZArkusza } from "./lib/krNormalize.js";
import {
  czyDzienRoboczyPl,
  ...
  return (
    <section style={{ maxWidth: "min(1200px, 100%)" }}>
      ...
      >
        ...
        >
          Godziny miesięczne pochodzą z eksportu w aplikacji Księgowość (Rozliczenia godzinowe →
          „Eksport do Vercel”). Tu możesz przeglądać i uzupełniać wpisy ręcznie — bez wczytywania plików
          .xlsx.
        </div>
      </div>
